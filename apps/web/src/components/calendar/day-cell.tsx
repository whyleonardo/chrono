...
export function DayCell({
	...
	const buttonClassName = useMemo(() => {
		const baseClasses =
			"relative flex h-full w-full flex-col justify-between rounded-xl border bg-neutral-950/40 p-2 text-left text-sm transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400";
