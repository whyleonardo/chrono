...
export function DayCell({
	...
	const buttonClassName = useMemo(() => {
		const baseClasses =
			"relative flex h-full w-full flex-col justify-between rounded-none border bg-neutral-950/40 p-1.5 text-left text-xs transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 md:p-2 md:text-sm";
