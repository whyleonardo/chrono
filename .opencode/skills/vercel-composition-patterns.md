...
This skill is based on [Vercel's Composition Patterns](https://github.com/vercel-labs/agent-skills/tree/main/skills/composition-patterns) from the [Vercel Agent Skills](https://github.com/vercel-labs/agent-skills) repository.
